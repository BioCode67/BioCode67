...
| Field | Description |
|-------|-------------|
| 🤖 Artificial Intelligence | Machine Learning, Deep Learning model training & applications |
| 📊 Data Analysis | Data collection, preprocessing, and visualization |
| 🖥️ Backend Development | Server development, API design, and database management |
...
- **Understanding Open Source Software** (Yeungnam Univ. Software Engineering Lab)
  - Version control with Git/GitHub (commit, stage, repository)
  - Managing `.gitignore` and tags
  - Hands-on practice with Sourcetree

---

## 🌱 Goals

- Gain experience in AI and Data Analysis projects
